...
The [original synthesis](../90-archive/first-party-erlang-otp-erts-webassembly-runtime-stack.md),
now superseded by the [canonical runtime architecture](../20-notes/erts-webassembly-runtime-architecture-and-milestones.md),
