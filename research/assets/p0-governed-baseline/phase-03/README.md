...
- [`p0-phase-03-acceptance-contract.json`](p0-phase-03-acceptance-contract.json) — digest-bound P0-A03 contract-research criteria and the explicit non-P0-GATE boundary.
...
- [`p0-phase-03-acceptance.planning-evidence.json`](p0-phase-03-acceptance.planning-evidence.json) — clean-revision contract evidence for P0-A03, without P0-GATE or runtime claims.
