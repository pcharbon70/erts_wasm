...
The archive is self-contained under the repository's `research/` directory. It
preserves the research originally developed in BlazeX while giving
...
Start at the [home map](10-maps/home.md), then use the [component implementation
deep dive](20-notes/erts-webassembly-component-implementation-deep-dive.md) for
the current POC and in-depth compatibility findings across all eleven
architectural components. Repository-wide authoring and maintenance conventions
...
- [Repository AGENTS.md](../AGENTS.md) — authoring, provenance, security, and maintenance rules.
