...
- [ERTS WebAssembly runtime architecture and
  ...
  is the canonical component model, architecture, runtime-loading contract,
  security model, proof program, and compatibility roadmap.
...
- The [main synthesis](../20-notes/erts-webassembly-runtime-architecture-and-milestones.md#how-otp-fits-into-the-stack)
...
- The synthesis's [day-one security
  model](../20-notes/erts-webassembly-runtime-architecture-and-milestones.md#security-from-day-one)
...
- The synthesis's [required
  measurements](../20-notes/erts-webassembly-runtime-architecture-and-milestones.md#required-measurements)
